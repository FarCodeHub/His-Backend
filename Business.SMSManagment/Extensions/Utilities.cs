...
namespace Business.SMSManagment.Extensions
{
    public class Utilities
    {
        ...
        public static int GetRoleIdBaseCenterType(CenterTypeEnum centerTypeEnum)
        {
        ...
        // do title => کاری که سرویس انجام میدهد مثلا ویرایش نام
        // errors => کلید نام پراپرتی است و ولیو خطای ایجاد شده
        public static string CreateErrorMessage(string doTitle, Dictionary<string, string> errors)
        {
            var result = new Dictionary<string, object>();
            result.Add(doTitle, errors);
